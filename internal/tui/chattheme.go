...
var chatThemeRegistry = []chatTheme{
	...
	},
	{
		...
		Label:           "codex",
		LowContrast:     false,
		AppBG:           lipgloss.Color("#0a1220"),
		PanelBG:         lipgloss.Color("#0a1220"),
		HeaderBG:        lipgloss.Color("#0a1220"),
	...
	},
	{
		...
		Label:           "opencode",
		LowContrast:     false,
		AppBG:           lipgloss.Color("#0c131d"),
		PanelBG:         lipgloss.Color("#0c131d"),
		HeaderBG:        lipgloss.Color("#0c131d"),
