...
var chatThemeRegistry = []chatTheme{
	{
		...
		Label:           "default",
		LowContrast:     false,
		AppBG:           lipgloss.Color("#171a1f"),
		PanelBG:         lipgloss.Color("#1b2027"),
		HeaderBG:        lipgloss.Color("#171a1f"),
		HeaderFG:        lipgloss.Color("#c7d0da"),
		Border:          lipgloss.Color("#2b313b"),
		BorderFocus:     lipgloss.Color("#7cc7ff"),
		Text:            lipgloss.Color("#c7d0da"),
		TextDim:         lipgloss.Color("#8f98a3"),
		AccentPrimary:   lipgloss.Color("#7cc7ff"),
		AccentSecondary: lipgloss.Color("#7cc7ff"),
