...
var chatThemeRegistry = []chatTheme{
	{
		...
		Label:           "default",
		LowContrast:     false,
		AppBG:           lipgloss.Color("#10141a"),
		PanelBG:         lipgloss.Color("#10141a"),
		HeaderBG:        lipgloss.Color("#10141a"),
		HeaderFG:        lipgloss.Color("#eef2f7"),
		Border:          lipgloss.Color("#26303b"),
		...
		Success:         lipgloss.Color("#8fd6a3"),
		Warning:         lipgloss.Color("#f0c674"),
		Error:           lipgloss.Color("#ff9b8b"),
	},
	{
		ID:              "low",
		Label:           "low contrast",
