...
var chatThemeRegistry = []chatTheme{
	{
		...
		Label:           "default",
		LowContrast:     false,
		AppBG:           lipgloss.Color("#0a0c0f"),
		PanelBG:         lipgloss.Color("#0a0c0f"),
		HeaderBG:        lipgloss.Color("#0a0c0f"),
		HeaderFG:        lipgloss.Color("#e7eaf0"),
		Border:          lipgloss.Color("#2a323c"),
		BorderFocus:     lipgloss.Color("#7dd3a0"),
		Text:            lipgloss.Color("#e7eaf0"),
		TextDim:         lipgloss.Color("#8a939d"),
		AccentPrimary:   lipgloss.Color("#7dd3a0"),
		AccentSecondary: lipgloss.Color("#8ab4f8"),
		Success:         lipgloss.Color("#7dd3a0"),
		Warning:         lipgloss.Color("#e9b872"),
		Error:           lipgloss.Color("#ff8a8a"),
	},
	{
		ID:              "low",
		Label:           "low contrast",
