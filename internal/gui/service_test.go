...
func TestBoundMethodSurface(t *testing.T) {
	want := []string{
		...
		// file manager
		"CreateWorkspaceFile", "CreateWorkspaceDir", "DeleteWorkspacePath",
		"RenameWorkspacePath", "CopyWorkspacePath",
		// scratch files
		"ScratchRoot", "ListScratch", "CreateScratchFile", "ReadScratchFile",
		"WriteScratchFile", "DeleteScratchFile", "RenameScratchFile", "CopyScratchFile",
...
func TestBrowsingRefusesEveryMutation(t *testing.T) {
	...
	mutations := map[string]func() error{
		...
		"CreateWorkspaceFile": func() error {
			_, err := s.CreateWorkspaceFile("a.txt", "")
			return err
		},
		"CreateWorkspaceDir":  func() error { return s.CreateWorkspaceDir("d") },
		"DeleteWorkspacePath": func() error { return s.DeleteWorkspacePath("a.txt") },
		"RenameWorkspacePath": func() error { return s.RenameWorkspacePath("a", "b") },
		"CopyWorkspacePath":   func() error { return s.CopyWorkspacePath("a", "b") },
