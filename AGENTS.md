...
## Existing Repo Notes
- Previous repo-level instructions were preserved at `AGENTS_renamed.md`.
- Apply the security protections in this file first. Treat `AGENTS_renamed.md` as supplemental context only.
