...
- [internal/agent/](./internal/agent): core agent loop, sub-agents, prompts, rendering
...
4. update tests
5. if multi-agent access matters, update allowed tool lists in [internal/agent/roles.go](./internal/agent/roles.go)
...
- role definitions in [internal/agent/roles.go](./internal/agent/roles.go)
...
- [internal/agent/agent_test.go](./internal/agent/agent_test.go)
